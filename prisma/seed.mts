  ...
  const menuItems = await Promise.all([
    ...
    prisma.menuItem.create({
      data: {
        ...
        price: 8.50,
        image: '/images/menu/scotch-egg.jpg',
        category: 'Starters',
      },
    }),
    prisma.menuItem.create({
    ...
    prisma.menuItem.create({
      data: {
        ...
        price: 11.50,
        image: '/images/menu/prawn-cocktail.jpg',
        category: 'Starters',
      },
    }),
    prisma.menuItem.create({
      data: {
        ...
        price: 13.95,
        image: '/images/menu/burrata-heritage-tomatoes.jpg',
        category: 'Starters',
      },
    }),
    // Mains
    ...
    prisma.menuItem.create({
      data: {
        ...
        price: 22.50,
        image: '/images/menu/pan-seared-sea-bass.jpg',
        category: 'Mains',
      },
    }),
    prisma.menuItem.create({
      data: {
        ...
        price: 17.50,
        image: '/images/menu/wild-mushroom-risotto.jpg',
        category: 'Mains',
      },
    }),
    // Grill
    prisma.menuItem.create({
      data: {
        ...
        price: 32.00,
        image: '/images/menu/8oz-ribeye-steak.jpg',
        category: 'Grill',
      },
    }),
    prisma.menuItem.create({
      data: {
        ...
        price: 28.50,
        image: '/images/menu/10oz-sirloin.jpg',
        category: 'Grill',
      },
    }),
    prisma.menuItem.create({
      data: {
        ...
        price: 26.00,
        image: '/images/menu/lamb-cutlets.jpg',
        category: 'Grill',
      },
    }),
    prisma.menuItem.create({
      data: {
        ...
        price: 18.95,
        image: '/images/menu/spatchcock-chicken.jpg',
        category: 'Grill',
      },
    }),
    // Sides
    prisma.menuItem.create({
      data: {
        ...
        price: 5.50,
        image: '/images/menu/triple-cooked-chips.jpg',
        category: 'Sides',
      },
    }),
    prisma.menuItem.create({
      data: {
        ...
        price: 7.50,
        image: '/images/menu/truffle-mac-and-cheese.jpg',
        category: 'Sides',
      },
    }),
    prisma.menuItem.create({
      data: {
        ...
        price: 5.95,
        image: '/images/menu/seasonal-greens.jpg',
        category: 'Sides',
      },
    }),
    prisma.menuItem.create({
      data: {
        ...
        price: 6.50,
        image: '/images/menu/roasted-root-vegetables.jpg',
        category: 'Sides',
      },
    }),
    // Desserts
    prisma.menuItem.create({
      data: {
        ...
        price: 9.50,
        image: '/images/menu/sticky-toffee-pudding.jpg',
        category: 'Desserts',
      },
    }),
    prisma.menuItem.create({
    ...
    prisma.menuItem.create({
      data: {
        ...
        price: 8.95,
        image: '/images/menu/eton-mess.jpg',
        category: 'Desserts',
      },
    }),
    prisma.menuItem.create({
      data: {
        ...
        price: 11.50,
        image: '/images/menu/cheese-board.jpg',
        category: 'Desserts',
      },
    }),
    // Drinks
    prisma.menuItem.create({
      data: {
        ...
        price: 5.50,
        image: '/images/menu/craft-lager.jpg',
        category: 'Drinks',
      },
    }),
    prisma.menuItem.create({
      data: {
        ...
        price: 7.50,
        image: '/images/menu/house-red-wine.jpg',
        category: 'Drinks',
      },
    }),
    prisma.menuItem.create({
